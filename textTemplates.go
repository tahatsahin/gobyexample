...
func main() {
	...
	// Alternatively, we can use the template.Must function to panic
	// in case Parse returns an error. This is especially useful for
	// templates initialized in the global scope.
	...
	// to access its fields. The fields should be exported to be
